...
#Steves Stuff
PRODUCT_COPY_FILES += \
    vendor/cm/prebuilt/xposed.apk:system/app/xposed.apk \
    vendor/cm/prebuilt/stats.apk:system/app/stats.apk \
    vendor/cm/prebuilt/Trickster.apk:system/app/Trickster.apk \
    vendor/cm/prebuilt/OmniSwitch.apk:system/priv-app/OmniSwitch.apk
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    ro.romstats.name=STEVES_UNOFFICIAL \
    ro.romstats.version=$(CM_VERSION)-b1 \
